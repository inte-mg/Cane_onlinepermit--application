...
public class Permit {
    ...
    public Permit(String farmerName, String mobileNo, String emailAddress, String idNo, String county,
                       String subCounty, String location, String farmSize, String landOwnership,
                       String waterSource, String sugarcaneVariety,String farmName, String previousYield, String date , String uid)
    {
    ...
    public String getPreviousYield() {
        return previousYield;
    }

    public void setPreviousYield(String previousYield) {
        this.previousYield = previousYield;
    }
